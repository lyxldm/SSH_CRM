...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/visitAction_execute"
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								<td>拜访人：</td>
								<td >
								<input type="hidden" name="user.id" style="WIDTH: 180px" id="choose1" value="<s:property value="#User.id" />" />
								<input type="text"  style="WIDTH: 180px" id="choose2" value="<s:property value="#User.user_name" />"/>
									<input type="button" value="选择客户" onclick="window.open('${pageContext.request.contextPath}/jsp/customer/list.jsp?flag=true','','width=600,height=300')" />
								</td>
							</TR>
							<tr>
								<td>拜访时间 ：(yyyy-mm-dd)</td>
								<td  >
